...
angular.module('luZhouApp')
  .controller('RankcourseclickCtrl', function ($scope, $rootScope, $cookieStore, commonService, $timeout, $loading, $stateParams) {
    ...
    $scope.getRankCourseClick = function (options) {
      var params = $.extend({}, ALL_PORT.CompletionRateList.data, options)
      commonService.getData(ALL_PORT.CompletionRateList.url, 'POST', params)
    ...
    $scope.paginationConf = $.extend({}, paginationConf, {itemsPerPage: ALL_PORT.CompletionRateList.data.rows});
