...
// var API_URL = "http://122.225.101.117:9061/api";
// var API_URL = "http://zhishan.jy365.net:81/api";
...
var ALL_PORT = {
  ...
  //课程完成率排行
  CompletionRate: {
    url: API_URL + "/Page/CompletionRate",
    data: {
      page: 1,
      rows: 19,
      sort: 'CompletionRate',
  ...
  //课程完成率排行详细页
  CompletionRateList: {
    url: API_URL + "/Page/CompletionRateList",
    data: {page: 1, rows: 20, sort: 'CompletionRate', order: 'desc', titleNav: '课程完成率排行榜', wordLimt: 17}
  },
  //登录次数排行
  LoginSumRank: {
  ...
  //个人中心当月课程和课程推荐
  GetMonthCourseList: {
    url: API_URL + "/Page/GetMonthCourseList",
    data: {page: 1, rows: 10, sort: 'BrowseScore', order: 'desc', titleNav: "个人中心", courseType: "Unfinish", title: ""}
  },
  //考试中心列表
  ExamList: {
  ...
  MessageList: {
    ...
    data: {page: 1, rows:10, sort: 'CreateDate', order: 'desc', titleNav: '留言板', wordLimt: '35',type:'my'}
  },
  //留言信息详情
  MessageDetail: {
    url: API_URL + "/Page/MessageDetail",
    data: {id: '', titleNav: '留言信息详情'}
  },
  //提交添加留言
  GetMessageAdd: {
  ...
  //个人学习档案
  StudyStatistics: {  //type userinfo study exam training
  ...
  //自动播放进度
  GetBrowseScore: {
    url: API_URL + "/CourseProcess/GetBrowseScore",
    data: { courseId: ''}
  },
  ...
  //二维码扫描
  CheckFace: {
    url: API_URL + "/home/CheckFace",
    data: {}
  },
    // 获取往月学习情况分类
  GetMonth: {
    url: API_URL + "/Page/GetMonth",
    data: {}
  },
};
